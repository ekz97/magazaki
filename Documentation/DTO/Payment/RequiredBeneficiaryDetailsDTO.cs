...
{
    public class RequiredBeneficiaryDetailsDTO
    {
        [JsonConstructor]
        public RequiredBeneficiaryDetailsDTO(
            List<RequiredFieldsListDTO> requiredFieldsList
        )
        {
            this.requiredFieldsList = requiredFieldsList;
        }

        [JsonPropertyName("requiredFieldsList")]
        public IReadOnlyList<RequiredFieldsListDTO> requiredFieldsList { get; }
    }
