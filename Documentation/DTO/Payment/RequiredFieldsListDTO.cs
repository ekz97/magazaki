...
{
    // RequiredBeneficiaryDetailsDTO myDeserializedClass = JsonSerializer.Deserialize<List<RequiredBeneficiaryDetailsDTO>>(myJsonResponse);
    public class RequiredFieldsListDTO
    {
        [JsonConstructor]
        public RequiredFieldsListDTO(
            string fieldName,
            bool? display,
            bool? required,
            string expression
